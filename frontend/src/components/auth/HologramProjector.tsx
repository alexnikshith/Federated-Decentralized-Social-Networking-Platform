...
export const HologramProjector = ({ children, className, isActive = true }: HologramProjectorProps) => {
    return (
        <div className={cn(
            "relative w-full max-w-[480px] mx-auto transition-all duration-[1000ms] ease-out z-20 mb-[30px]",
            isActive ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-95 translate-y-32 pointer-events-none",
            className
        )}>
            {/* ── Content container ── */}
            < div className="relative z-10 w-full min-h-[280px] flex items-center justify-center pt-3 pb-4" >
